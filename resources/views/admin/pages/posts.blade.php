    ...
    <div data-dialog-backdrop="sign-in-modal" data-dialog-backdrop-close="true"
        ...
        <div data-dialog="sign-in-modal" data-dialog-mount="opacity-100 translate-y-0 scale-100"
            ...
            <div class="relative flex flex-col bg-white">
                ...
                <form class="w-full" action="/dashboard/posts" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <tbody>
                        ...
                        @foreach ($posts as $data)
                            <tr>
                                <td class="py-3  px-5 border-b border-blue-gray-50">
                                    <div class="flex items-center gap-4">
                                        <img src="/storage/{{ $data->image }}" alt=""
                                            class="w-full max-w-[200px] relative rounded-md" />
                                    </div>
                                </td>
                                <td class="py-3  px-5 border-b border-blue-gray-50">
                                ...
                                <td class="py-3  px-5 border-b border-blue-gray-50">
                                    <form id="confirm" action="/dashboard/posts/{{ $data->id }}" method="post">
                                        @method('delete')
                                        @csrf
