        ...
        <div class="w-full bg-white  px-5 py-16 md:py-24 text-gray-800">
            <div class="w-full max-w-6xl mx-auto">
                ...
                <div class="-mx-3 md:flex items-start">
                    @foreach (collect($testimonal)->skip(1) as $data)
                            ...
                            <div
                                ...
                                <div class="w-full flex mb-4 items-center">
                                    ...
                                    <div class="flex-grow pl-3">
                                        <h6 class="font-bold text-sm uppercase text-gray-600">{{ $data->name }}</h6>
                                    </div>
                                </div>
                                <div class="w-full">
                                    <p class="text-sm leading-tight"><span
                                            class="text-lg leading-none italic font-bold text-gray-400 mr-1">"</span>{{ $data->message }}<span
