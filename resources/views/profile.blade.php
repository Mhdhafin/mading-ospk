<x-layout>
    ...
    <div class="h-screen bg-white flex flex-wrap items-center  justify-center  ">
        <div
            class="container lg:w-1/2 xl:w-2/7 sm:w-full md:w-2/3    bg-white  shadow-lg    transform   duration-200 easy-in-out">
